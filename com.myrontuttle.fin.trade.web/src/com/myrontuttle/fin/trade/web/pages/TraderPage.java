...
import com.myrontuttle.fin.trade.web.panels.TraderParametersTablePanel;
...
public class TraderPage extends WebPage {
	...
	public TraderPage(long traderId) {
		...
		add(new TraderParametersTablePanel("traderInstructionsTable", traderId));
	}
